...
class RecordList extends Component {
    ...
    render() {
        ...
        // If there are records, render them
        return (
            <div className="notes">
                {details.map(arr => {
                    if (arr.record_id !== 0) {
                        ...
                        return (
                            <div className="card" key={arr.record_id}>
                                ...
                                {/* Add your update link here */}
                                <Link to={`/updateCertificate/${arr.record_id}`}>
                                    <button type="button" className="dropbtn1">Update Certificate</button>
                                </Link>
                            </div>
                        );
                    }
